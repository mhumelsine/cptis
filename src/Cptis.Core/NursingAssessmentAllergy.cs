...
{
    public class NursingAssessmentAllergy
    {
        /// <summary>
        /// Unique identifier for the allergy record.
        /// </summary>
        public int NursingAssessmentAllergyId { get; set; }
        ...
        /// <summary>
        /// Description of the allergic reaction to the allergen.
        /// </summary>
        public string Reaction { get; set; }

        /// <summary>
        /// The date and time the allergy record was created.
        /// </summary>
        public DateTime? CreateDate { get; set; }

        /// <summary>
        /// The date and time the allergy record was last updated.
        /// </summary>
